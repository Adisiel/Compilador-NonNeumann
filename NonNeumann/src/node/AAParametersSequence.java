...
public final class AAParametersSequence extends PAParametersSequence
{
    private PAParameter _aParameter_;

    public AAParametersSequence()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAParametersSequence(
            cloneNode(this._aParameter_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAAParametersSequence(this);
    }
