...
public final class AAListExpressionsSequence extends PAListExpressionsSequence
{
    private PAExpression _aExpression_;

    public AAListExpressionsSequence()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAListExpressionsSequence(
            cloneNode(this._aExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAAListExpressionsSequence(this);
    }
