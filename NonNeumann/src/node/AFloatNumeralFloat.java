...
public final class AFloatNumeralFloat extends PNumeralFloat
{
    private TFloat _float_;

    public AFloatNumeralFloat()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFloatNumeralFloat(
            cloneNode(this._float_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFloatNumeralFloat(this);
    }
