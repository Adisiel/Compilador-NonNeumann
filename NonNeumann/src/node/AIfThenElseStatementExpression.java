...
public final class AIfThenElseStatementExpression extends PExpression
{
    private PIfThenElseStatement _ifThenElseStatement_;

    public AIfThenElseStatementExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIfThenElseStatementExpression(
            cloneNode(this._ifThenElseStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAIfThenElseStatementExpression(this);
    }
