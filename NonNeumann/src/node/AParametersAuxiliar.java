...
public final class AParametersAuxiliar extends PParametersAuxiliar
{
    private TComma _comma_;
    private PParameter _parameter_;

    public AParametersAuxiliar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParametersAuxiliar(
    ...
    {
        ((Analysis) sw).caseAParametersAuxiliar(this);
    }
