...
public final class AIfStatementExpression extends PExpression
{
    private PIfStatement _ifStatement_;

    public AIfStatementExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIfStatementExpression(
            cloneNode(this._ifStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAIfStatementExpression(this);
    }
