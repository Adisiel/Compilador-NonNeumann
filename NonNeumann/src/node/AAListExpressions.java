...
public final class AAListExpressions extends PAListExpressions
{
    ...
    public AAListExpressions(
        ...
        @SuppressWarnings("hiding") List<PAListExpressionsSequence> _aListExpressionsSequence_)
    {
        // Constructor
    ...
    public void setAListExpressionsSequence(List<PAListExpressionsSequence> list)
    {
        this._aListExpressionsSequence_.clear();
        this._aListExpressionsSequence_.addAll(list);
        for(PAListExpressionsSequence e : list)
        {
            if(e.parent() != null)
            {
