...
public final class AFunctionParameters extends PFunctionParameters
{
    ...
    public Object clone()
    {
        return new AFunctionParameters(
    ...
    {
        ((Analysis) sw).caseAFunctionParameters(this);
    }
