...
public final class AABlockExpression extends PABlockExpression
{
    ...
    public AABlockExpression(
        @SuppressWarnings("hiding") List<PADeclarationConstant> _aDeclarationConstant_,
    ...
    public void setADeclarationConstant(List<PADeclarationConstant> list)
    {
        this._aDeclarationConstant_.clear();
        this._aDeclarationConstant_.addAll(list);
        for(PADeclarationConstant e : list)
        {
            if(e.parent() != null)
            {
