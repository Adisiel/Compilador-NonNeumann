...
public final class AFalseBooleanValue extends PBooleanValue
{
    private TFalse _false_;

    public AFalseBooleanValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFalseBooleanValue(
            cloneNode(this._false_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFalseBooleanValue(this);
    }
